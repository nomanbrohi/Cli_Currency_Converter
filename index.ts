...
if(selectCurrency === "USD Dollar")
    {
        ...
        {   
            ...
            if(isNaN(dollarToPkr.dollar))
                ...
                {
                let convert_Dollar: number = dollarToPkr.dollar * currencies.usd_dollar;
        ...
        while(true)
            {
                ...
                if (isNaN(kDinarToPkr.dinar))
                    ...
                    {
                        let convert_k_Dinar: number = kDinarToPkr.dinar * currencies.k_dinar;
    ...
    while(true)
            {
                ...
                if (isNaN(ausToPkr.dollar))
                    ...
                    {
                        let convert_ausDollar: number = ausToPkr.dollar * currencies.aus_dollar;
    ...
    while(true)
            {
                ...
                if (isNaN(saudi_riyal.riyal))
                    ...
                    {
                        let convert_saudiRiyal: number = saudi_riyal.riyal * currencies.saudi_riyal;
